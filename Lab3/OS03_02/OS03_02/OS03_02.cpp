...
int main()
{
    ...
    LPCWSTR chp1 = L"E:\\1Uni\\ОСИСП(Смелов)\\Лабораторные\\Лабораторная 3\\OS03_02_1\\Debug\\OS03_02_1.exe"; 
    LPCWSTR chp2 = L"E:\\1Uni\\ОСИСП(Смелов)\\Лабораторные\\Лабораторная 3\\OS03_02_2\\Debug\\OS03_02_2.exe";
